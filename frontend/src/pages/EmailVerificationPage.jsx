...
const EmailVerificationPage = () => {
	...
	return (
		<div className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-2xl shadow-2xl border border-purple-600'>
			<motion.div
					...
					<div className='flex justify-between'>
						{code.map((digit, index) => (
							<input
								...
								className='w-12 h-12 text-center text-2xl font-bold bg-gray-700 text-white border-2 border-purple-600 rounded-lg focus:border-purple-500 focus:outline-none'
							/>
						))}
					</div>
